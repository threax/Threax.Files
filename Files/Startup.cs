...
namespace Files
{
    public class Startup
    {
        ...
        {
            Scope = "Files", //The name of the scope for api access
            DisplayName = "Files", //Change this to a pretty name for the client/resource
            ClientId = "Files", //Change this to a unique client id
